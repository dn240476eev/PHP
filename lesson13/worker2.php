...
<h2 style="text-align: center; color: blue;">1.2. Класс Worker - private поля </h2>
...
if (!empty($name1) && !empty($name2) && !empty($age1) && !empty($age2) && !empty($salary1) && !empty($salary1)) {
    ...
    echo '<h4>Сумма возрастов работников ', $worker1->getName(), ', ', $worker2->getName(), ': </h4>', $summ_age . PHP_EOL;
